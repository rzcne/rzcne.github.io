...
const proxyIPs = ["cf.cdn.bingbook.cn"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org cf.cdn.bingbook.cn
const cn_hostnames = [''];
...
function getVLESSConfig(userID, hostName) {
  ...
  const note = `启程YouTube频道：https://www.youtube.com/@set-out\n\nProxyIP全局运行中：${proxyIP}`;
